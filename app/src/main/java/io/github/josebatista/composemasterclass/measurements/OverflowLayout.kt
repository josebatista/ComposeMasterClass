...
fun OverflowLayout(
    ...
    SubcomposeLayout(
        ...
        val maxMainPlaceableWidth = mainPlaceables.fastMaxOfOrNull { it.width } ?: 0
        val maxMainPlaceableHeight = mainPlaceables.fastMaxOfOrNull { it.height } ?: 0
        val maxOverflowPlaceableWidth = overflowPlaceables.fastMaxOfOrNull { it.width } ?: 0
        val maxOverflowPlaceableHeight = overflowPlaceables.fastMaxOfOrNull { it.height } ?: 0
        ...
        layout(width, height) {
            mainPlaceables.fastForEach { placeable -> placeable.place(0, 0) }
            overflowPlaceables.fastForEach { placeable ->
